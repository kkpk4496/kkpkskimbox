      ...
      <div className="cardcontainer">
        <div className="firstcard">
          ...
          <div style={{display: 'flex', flexDirection: 'column'}}>
            ...
            >
              <AiOutlineCheck style={blueColor} />
          ...
          <div className="lastbutton">
            <button type="button" className="freebutton">
              Try for free
            </button>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <h1 className="tickhead">What's included on Shopify</h1>
          <div style={{display: 'flex', flexDirection: 'column'}}>
            <div
              style={{
                display: 'flex',
        ...
        <div className="advancedcard">
          ...
          <p className="card-description">
            Get the best of Shopify with custom reporting and out lowest
            trancaction fees
          </p>
          <div className="pricecontainer">
            <p className="card-price">
              <strong>₹30,164</strong>
            </p>
            <div className="priceendtag">
              <p>
                INR <br />
